...
## ----out.width='75%', echo=FALSE, fig.align='center', fig.cap='Figure 7: *Shiny* app to change default settings when filtering features based on their annotations'----
knitr::include_graphics('./images/microRNAs.png')

## ----out.width='75%', echo=FALSE, fig.align='center', fig.cap="Figure 8: Hierarchical clustering of based on reads' counts. Patients' specificity overwhelms the effects of treatment as previously indicated by PCA. Custom palette specifically designed to highlight differences in gene expression."----
knitr::include_graphics('./images/heatmap_before.png')

## ----out.width='75%', echo=FALSE, fig.align='center', fig.cap='Figure 9: Hierarchical clustering of based on Z-score transformed data. Effects of bias were clearly reduced, making data comparable. Custom palette specifically designed to highlight differences in gene expression.'----
knitr::include_graphics('images/heatmap_after.png')

## ----out.width='75%', echo=FALSE, fig.align='center', fig.cap='Figure 10: PCA on Z-score trasformed data confirms correction of the bias due to specificity of patients.'----
